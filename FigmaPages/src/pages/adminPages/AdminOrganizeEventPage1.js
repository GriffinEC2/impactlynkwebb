...
const AdminOrganizeEventPage1 = () => {
  const onFrameButton2Click = useCallback(() => {
    //TODO: Submit form and send back to admin home page
  }, []);

  return (
    <div className="w-full relative [background:linear-gradient(112.9deg,_#bdbdbd_12%,_#808080)] h-[832px] overflow-hidden flex flex-col items-center justify-start gap-[40px]">
      <TopBar
        signIn="Organize"
        signIn1="Manage"
        signIn2="About Us"
      ...
      <div className="overflow-hidden flex flex-row items-center justify-start py-10 px-[65px] gap-[66px]">
        <div className="rounded-mini bg-white shadow-[2px_2px_15px_4px_rgba(0,_0,_0,_0.25)] overflow-hidden flex flex-col items-center justify-start py-10 px-[26px] gap-[10px]">
          <Login1 label="Start Time" text="MM/DD/YYYYY" />
          <Login1 label="End Time" text="MM/DD/YYYYY" />
          <ContactScreen
            hide="Error message"
            send="Or email us at "
            showFrameDiv={false}
        ...
        <div className="rounded-mini bg-white shadow-[2px_2px_15px_4px_rgba(0,_0,_0,_0.25)] h-[577px] overflow-hidden flex flex-col items-center justify-start py-10 px-[26px] box-border gap-[10px]">
          ...
          <div className="w-[481px] h-[88px] overflow-hidden shrink-0 flex flex-col items-start justify-center py-3 px-0 box-border">
            <button
              className="cursor-pointer [border:none] p-0 bg-gray-200 w-[153px] relative rounded-13xl h-[50px] overflow-hidden shrink-0"
              onClick={onFrameButton2Click}
            >
              <div className="absolute top-[calc(50%_-_32px)] left-[calc(50%_-_98.5px)] text-base font-medium font-poppins text-dimgray-200 text-center flex items-center justify-center w-[197px] h-16">
                Complete
              </div>
            </button>
          </div>
...
export default AdminOrganizeEventPage1;
