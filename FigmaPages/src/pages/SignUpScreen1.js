...
const SignUpScreen1 = () => {
  ...
  return (
    <div className="w-full relative bg-gray-1600 h-[832px] overflow-hidden">
      <div className="absolute top-[0px] left-[0px] bg-gainsboro-200 w-[1280px] h-[832px]">
        <img
          className="absolute top-[0px] left-[780px] w-[500px] h-[832px] object-cover"
          alt=""
          src="/rectangle-7@2x.png"
        />
      </div>
      <div className="absolute top-[157px] left-[132px] flex flex-row items-center justify-center gap-[205px]">
        <SignUp
          ...
          googleButtonFrameLeft="calc(50% - 51px)"
