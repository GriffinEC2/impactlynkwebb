    ...
    return (
        <UserContext.Provider value={value}>
            <Routes>
                ...
                />
                <Route
                    path="/manage-volunteers-2"
                    element={<ManageVolunteers1 />}
                />
                <Route
                ...
                <Route
                    path="/admin-view-all-orgs"
                    element={<AdminViewAllOrgs />}
                />
                <Route
                ...
                <Route
                    path="/post-volunteer-page-2"
                    element={<PostVolunteerPage />}
                />
                <Route path="/post-home-page" element={<PostHomePage />} />
                <Route
                    path="/post-volunteer-page-1"
                    element={<PostVolunteerPage1 />}
                />
                <Route
                    path="/post-about-us-page"
                    element={<PostAboutUsPage />}
                />
                ...
                <Route
                    path="/pre-volunteer-page-1"
                    element={<PreVolunteerPage />}
                />
                <Route
                    path="/pre-volunteer-page-2"
                    element={<PreVolunteerPage1 />}
                />
                <Route
