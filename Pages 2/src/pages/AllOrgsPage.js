  ...
  return (
    <div className="w-full relative bg-white h-[832px] overflow-hidden flex flex-col items-start justify-start gap-[30px] text-center text-5xl text-black font-poppins">
      <Property1PostSignIn
        ...
        signIn1="About Us"
        signIn2="Stats"
        property1PostSignInWidth="1280px"
        property1PostSignInHeight="100px"
        property1PostSignInBorder="unset"
        property1PostSignInGap="400px"
        property1PostSignInBoxShadow="0px 10px 10px rgba(0, 0, 0, 0.25)"
      ...
      <div className="w-[1212px] h-[605px] overflow-hidden shrink-0 flex flex-col items-start justify-start py-5 pr-5 pl-[53px] box-border gap-[10px] text-left text-base">
