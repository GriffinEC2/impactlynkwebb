...
const VolunteerButton = ({ arrow1, volunteer, propColor }) => {
  const volunteer1Style = useMemo(() => {
    return {
      color: propColor,
    };
  }, [propColor]);
  ...
  return (
    <button className="cursor-pointer [border:none] p-0 bg-[transparent] w-[432px] relative h-[29px]">
      <img
